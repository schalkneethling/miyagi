...
/**
 * @param {object} totals
 * @returns {string[]} the component paths summed into this banner
 */
function variationComponents(totals) {
  // Errors[] gives missing components; this banner is a tooltip aid for
  // humans, so just list error paths if any.
