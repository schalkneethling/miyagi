...
- **_miyagi_ is now using a presentation mode when creating a static build.**
  ...
  More information: [The UI / Presentation vs Development mode](/the-ui/presentation-vs-dev-mode/)
...
- **Theming _miyagi_ got revised.**
  ...
  More information: [How-to / Theming the UI](/how-to/theming-the-ui/)

- **You can now pass an `AJV` import to _miyagi_ if you want to use a specific JSON schema version.**

  More information: [How-to: Configuring the JSON Schema validator](/how-to/configuring-the-json-schema-validator/)
...
More information: [JavaScript API](/javascript-api/)
...
- **Reusable definitions in mock files.**
  ...
  More information: [How-to / Writing mock data](/how-to/writing-mock-data/#using-definitions)
...
- **Global JSON Schema definitions**
  ...
  More information: [How-to / Using a global JSON Schema](/how-to/using-a-global-json-schema/)
